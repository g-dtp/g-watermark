(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["g-watermark"] = factory();
	else
		root["g-watermark"] = factory();
...
// CONCATENATED MODULE: ./packages/src/watermark.js
var watermark = {};
...
/* harmony default export */ var src_watermark = (watermark);
...
// CONCATENATED MODULE: ./packages/src/canvas2some.js
...
function downloadImage(fileName, dataBase) {
  var time = new Date();
  var name = fileName + time.getFullYear() + (time.getMonth() + 1) + time.getDate(); // 兼容IE

  if (window.navigator.msSaveOrOpenBlob) {
    var bstr = atob(dataBase.split(',')[1]);
    var n = bstr.length;
...
function canvas2hd(fileName, canvas) {
  var base64 = getHdThumbnail(canvas);
...
/* harmony default export */ var canvas2some = ({
  canvas2hd: canvas2hd,
  getHdThumbnail: getHdThumbnail
});
...
/* concated harmony reexport Watermark */__webpack_require__.d(__webpack_exports__, "Watermark", function() { return src_watermark; });
/* concated harmony reexport Canvas2some */__webpack_require__.d(__webpack_exports__, "Canvas2some", function() { return canvas2some; });
...
//# sourceMappingURL=g-watermark.umd.js.map